...
public class EditProfileActivity extends BaseActivity {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (dataSnapshot.hasChild("image")) {
                                ...
                                if (image != null && !TextUtils.isEmpty(image)) {
                                    PicassoCache.get(EditProfileActivity.this)
                                            .load(image)
    ...
    void setSaveBtn() {
        name = usernameInput.getEditableText().toString().trim();
        status = statusInput.getEditableText().toString().trim();
        if (TextUtils.isEmpty(name)) {
            usernameInput.setError(getString(R.string.user_name_empty));
            return;
        }
        if (TextUtils.isEmpty(status)) {
            statusInput.setError(getString(R.string.status_empty));
            return;
        }
